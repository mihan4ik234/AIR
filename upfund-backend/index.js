...
mongoose.connect(
  'mongodb+srv://admin:wwwwww@cluster0.fcfsaxo.mongodb.net/blog?retryWrites=true&w=majority&appName=Cluster0'
...
app.get('/tags', ProjectController.getLastTags);

app.get('/projects', ProjectController.getAll);
app.get('/', ProjectController.getAll);
app.get('/projects/tags', ProjectController.getLastTags);
